<template>
  <div class="container-xl mb-5 footer">
    <div class="row">
      ...
      <div class="col-12 col-lg-6 mt-2">
        <div class="d-flex flex-wrap justify-content-center justify-content-lg-start align-items-center small">
          <div v-for="item in footerNav">
            <AutoLink
              :url="item.link"
              class="d-inline-block nowrap me-4 mt-2 subtext"
            >
              {{ item.text }}
            </AutoLink>
          </div>
      ...
      <div class="col-12 col-lg-6 mt-2">
        <div class="d-flex flex-wrap justify-content-center justify-content-lg-end align-items-center small">
          ...
          <p class="d-lg-inline-block ms-3">
            <p class="subtext" style="margin-bottom: 0;" v-html="copyrightTxt"></p>
          </p>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    footerSlogan () {
      return this.$lang == 'zh-CN'? '纵横交通，乐趣其中' : 'Aesthetic Transportation'
    },

    redBook () {
      return this.$lang == 'zh-CN'? '小红书「交通美学研究所」' : 'RedBook「交通美学研究所」'
    },

    footerNav () {
      return this.$themeLocaleConfig.footerNav || this.$site.themeConfig.footerNav || []
    },

    copyrightTxt () {
      return this.$lang == 'zh-CN'? '本站全部内容禁止商业使用<br>License <span class="nowrap"><b>CC</b> BY-NC-SA 4.0</span>' : 'Commercial use of the content on this site is prohibited. <br>License <span class="nowrap"><b>CC</b> BY-NC-SA 4.0</span>'
    }
