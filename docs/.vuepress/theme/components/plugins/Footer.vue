  ...
  <div class="container-xl mb-5">
    <div class="row">
      <div class="col-12 col-md-6 mt-3">
        <h4 class="d-inline-block bold">联系我们</h4>
        <h5 class="ms-2 subtext d-inline-block">Contact Us</h5>
        <p class="mt-2 mb-0" title="QQ群">
          ...
          <span class="ms-2">LJR交通美学研究所 <code>325616319</code></span>
        </p>
